...
export default function BusinessHome() {
  return (
    <div className="flex flex-col gap-5">
        ...
        <div className="text-center text-green-800 text-[50px] font-black">Play golf on business trips with ease</div>
        <div className="w-[1000px] text-center gap-8 text-neutral-700 text-lg font-normal leading-[30px] flex flex-col">
